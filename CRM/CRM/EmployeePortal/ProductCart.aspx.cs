    ...
    public partial class ProductCart : System.Web.UI.Page
    {
        ...
        protected void btnAdd_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    bool a = IsValid;
                    objLead.AddProduct(txtItemCode.Text, txtItemName.Text, txtItemDescription.Text," ", cbActive.Checked);
                ...
                {
                    objLead.UpdateProduct(Convert.ToInt32(Session["id"].ToString()), txtItemCode.Text, txtItemName.Text, txtItemDescription.Text," ", cbActive.Checked);
                    if (objLead.IsError == true)
                    {
