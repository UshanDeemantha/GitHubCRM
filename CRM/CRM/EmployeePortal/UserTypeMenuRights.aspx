        ...
        <section class="content-header">
          ...
          Menu Rights Assign
           <%-- <small>Advanced form element</small>--%>
            ...
            <ol class="breadcrumb">
                <li><a href="LeadRegistration.aspx"><i class="fa fa-dashboard"></i>Home</a></li>
                                ...
                                <div class="row">
                                         <div class="col-md-8">
                                             ...
                                             <div class="col-md-5">
                                                  <dx:ASPxComboBox ID="txtUserRole" Height="25px" BackColor="#F5F5F5" runat="server"  DropDownStyle="DropDownList" DataSourceID="SqlDsUserType" AutoPostBack="true"
                                                        ValueField="UserTypeId" ValueType="System.String" TextFormatString="{0}" NullText=" << Select UserType >> " MaxLength="50">
                                                        <Columns>
                                          ...
                                          <div class="col-md-8">
                                             ...
                                             <div class="col-md-5">
                                                  <dx:ASPxComboBox ID="dxUsers" Height="25px" BackColor="#F5F5F5" runat="server" DropDownStyle="DropDownList" DataSourceID="objdsUser"
                                                                    ValueField="Id" TextField="UserName" ValueType="System.String" TextFormatString="{0}" NullText=" << Select Location >> " >
                                                        <Columns>
                                                                <dx:ListBoxColumn FieldName="UserName" Width="100px" />
                                                        </Columns>
                                                        <ValidationSettings Display="Dynamic" ErrorDisplayMode="ImageWithTooltip" ErrorTextPosition="Right">
                                            ...
                                            <ul class="messages_layout">
                                                ...
                                                <li > 
                                                    <div class="message_wrap"> <span class="arrow"></span>
                                                        <div class="info"> <a class="name">ADMINISTRATION MENU</a> <span class="time"></span>
                                                    ...
                                                    <div class="text"> <dx:ASPxCheckBoxList ID="chadminAdd" runat="server" ValueType="System.String" RepeatColumns="3" RepeatDirection="Horizontal" Theme="Office2003Blue" required></dx:ASPxCheckBoxList> 
                                                    </div>
                                                </li>
                                                <br />  
                                                <br />  
                                                <li > 
                                                    ...
                                                    <div class="text"> <dx:ASPxCheckBoxList ID="common" runat="server" ValueType="System.String" RepeatColumns="3" RepeatDirection="Horizontal" Theme="Office2003Blue"></dx:ASPxCheckBoxList> 
                                                    </div> 
                                                    <br/>
                                                 </li>
                                            </ul>
                                       ...
                                       <div class="box-footer">
                                            <div class="pull-right" style="margin-left: 3px">
                                                <dx:ASPxButton ID="btnClr"  Width="80px" Height="20px" runat="server" CssClass="btn btn-info" Paddings-Padding="3px" CausesValidation="False" Text="Cancel" OnClick="btnClr_Click">
                                                </dx:ASPxButton> 
                                            </div>
                                            <div class="pull-right" style="margin-left: 3px">
                                                <dx:ASPxButton ID="btSaveExtarActivity" runat="server"   CssClass="btn btn-info"  Paddings-Padding="3px"  Width="80px" Height="20px" Text="Submit" OnClick="btSaveExtarActivity_Click">
                                                </dx:ASPxButton>
                                            </div>
                                       </div>
                                    </div>
