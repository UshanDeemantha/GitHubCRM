           ...
           <asp:UpdatePanel ID="UpdatePanel2" runat="server" UpdateMode="Conditional">
                ...
                <div class="box box-default">
                    ...
                    <div class="box-body">
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                ...
                                <div class="col-md-4">
                                    <asp:Button ID="radbtnChange" CausesValidation="false" runat="server" ButtonType="LinkButton" CssClass="btn btn-info" Text="Change Password" BorderStyle="None" OnClick="radbtnChange_Click" />
                   ...
                   <div class="pull-right" style="margin-left: 3px">
                                         <dx:ASPxButton ID="btClear"  Width="80px" Height="20px" runat="server" CssClass="btn btn-info" Paddings-Padding="3px" CausesValidation="False" Text="Cancel" OnClick="btClear_Click" >
                                         </dx:ASPxButton> 
                                        </div>
                                        <div class="pull-right" style="margin-left: 3px">
