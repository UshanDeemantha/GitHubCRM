...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <section class="content-header">
                    ...
                    <div class="box-body">
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                ...
                                <div class="col-md-2">
                                    <button runat="server" class="bouton-image monBouton btn btn-info" onserverclick="bntuser_Click" style="width:80px;height:27px; padding-top:2px">Add New</button>
                                </div>
                            </div>
                          ...
                          <div class="pull-right" style="margin-left: 3px">
                            ...
                            <div class="col-md-12">
                                     ...
                                     <dx:ASPxGridView ID="gvUserDetails" runat="server" AutoGenerateColumns="False" Font-Size ="Small" DataSourceID="dsUserDetails" CssClass="col-md-12"
                                        ClientIDMode="AutoID" EnableTheming="True" KeyFieldName="UserId" Theme="MetropolisBlue" Width="100%">
                                        ...
                                        <Columns>
                                            ...
                                            <dx:GridViewDataTextColumn FieldName="UserTypeName" Caption="Login Type" VisibleIndex="2" Width="140">
                                            </dx:GridViewDataTextColumn>
                                            <dx:GridViewDataTextColumn FieldName="UserName" Caption="User Name" VisibleIndex="0" Width="140">
                                            </dx:GridViewDataTextColumn>
                                              <dx:GridViewDataTextColumn FieldName="LocationName" Caption="Location" VisibleIndex="3" Width="140">
                                            </dx:GridViewDataTextColumn>
                                            <dx:GridViewDataCheckColumn FieldName="IsBlocked" Caption="Blocked" Width="50px" VisibleIndex="4">
                                            ...
                                            <dx:GridViewDataTextColumn Caption="Select" VisibleIndex="5" Width="100px">
                                                <DataItemTemplate>
      ...
      <div class="row">
        ...
        ClientInstanceName="popup" PopupElementID="popupArea" ShowOnPageLoad="True"  Theme="iOS"
...
<dx:PopupControlContentControl ID="PopupControlContentControl2" runat="server" >
    ...
    <table style="width:100%;" class="newFont">
        ...
        <tr>
            ...
            <td class="auto-style1" style="font-size:13px;text-align:center">User Type</td>
            <td >
        ...
        <tr>
            <td class="auto-style1" style="font-size:13px;text-align:center" >Active</td>
        ...
        <div class="box-footer">
                                        ...
                                        EnableTheming="True" KeyFieldName="UserTypeId" Theme="MetropolisBlue" Width="100%" >
