<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProductCart.aspx.cs" Inherits="HRM.EmployeePortal.ProductCart" MasterPageFile="~/Portal.Master" %>
                ...
                <div class="box box-default">
                    ...
                    <div class="box-body">
                        <div class="row">
                                ...
                                <div class="col-md-3">
                                    <label for="txtItemName" id="Label4" class="auto-style1">Product Code</label></div>
                                <div class="col-md-2">
                            ...
                            <div class="col-md-8">
                                ...
                                <div class="col-md-3">
                                    <label for="txtItemName" id="lblUserName" class="auto-style1">Product Name</label></div>
                                <div class="col-md-5">
                          ...
                          <div class="pull-right" style="margin-left: 3px">
                            ...
                            <div class="col-md-12">
                                     ...
                                     <dx:ASPxGridView ID="gvItem" runat="server" AutoGenerateColumns="False" Font-Size ="Small" DataSourceID="dsItem" CssClass="col-md-12"
                                        ClientIDMode="AutoID" EnableTheming="True" KeyFieldName="ItemId" Theme="MetropolisBlue" Width="100%">
