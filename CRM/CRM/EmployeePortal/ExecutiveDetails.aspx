<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ExecutiveDetails.aspx.cs" Inherits="HRM.EmployeePortal.ExecutiveDetails" MasterPageFile="~/Portal.Master"%>
                    ...
                    <div class="box-body">
                        <div class="row">
                                ...
                                <div class="col-md-2">
                                    <dx:ASPxTextBox ID="txtEPFNo" BackColor="#F5F5F5" Height="25px" runat="server" Width="100%" MaxLength="10">
                                        <ValidationSettings Display="Dynamic" ErrorDisplayMode="ImageWithTooltip" ErrorTextPosition="Right">
                                            <RequiredField IsRequired="true" ErrorText="Employee Code is required" />
                                        </ValidationSettings>
                         ...
                         <div class="col-md-8">
                                ...
                                <div class="col-md-3">
                                    <label for="txtName" id="Label2" class="auto-style1">Executive Name</label></div>
                                    <div class="col-md-5">
                          ...
                          <div class="pull-right" style="margin-left: 3px">
                            ...
                            <div class="col-md-12">
                                     ...
                                     <dx:ASPxGridView ID="gvExecutive" runat="server" AutoGenerateColumns="False" Font-Size ="Small" DataSourceID="dsExecutive" CssClass="col-md-12"
                                        ClientIDMode="AutoID" EnableTheming="True" KeyFieldName="ExecutiveId" Theme="MetropolisBlue" Width="100%">
                                        ...
                                        <Columns>
                                            ...
                                            <dx:GridViewDataTextColumn FieldName="ExecutiveId" Caption="Id" VisibleIndex="1" CellStyle-CssClass="col-md-5"  Visible="false">
                                             ...
                                             <dx:GridViewDataTextColumn FieldName="EPFNo" Caption="Employee Code" VisibleIndex="2" Width="50px" >
                                                 <CellStyle HorizontalAlign="Center" />
                                            </dx:GridViewDataTextColumn>
                                              <dx:GridViewDataTextColumn FieldName="Name" Caption="Executive Name" VisibleIndex="3">
                                            </dx:GridViewDataTextColumn>
                                            <dx:GridViewDataTextColumn FieldName="ContactNo" Caption="Contact No" VisibleIndex="4">
                                                <CellStyle HorizontalAlign="Center" />
                                            </dx:GridViewDataTextColumn>
                                            ...
                                            <dx:GridViewDataTextColumn FieldName="LocationName" Caption="Location"  VisibleIndex="7">
                                             ...
                                             <dx:GridViewDataTextColumn FieldName="Email" Caption="Email" VisibleIndex="6">
                                                  ...
                                                  <dx:GridViewDataCheckColumn FieldName="Active" Caption="Active" Width="30px" VisibleIndex="8">
                                                <CellStyle HorizontalAlign="Center" />
                                            </dx:GridViewDataCheckColumn>
                                           
                                          
                                            <dx:GridViewDataTextColumn Caption="Select" VisibleIndex="8" Width="100px">
                                                <CellStyle HorizontalAlign="Center" />
                                                <DataItemTemplate>
